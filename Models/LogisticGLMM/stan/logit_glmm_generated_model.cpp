...
namespace logit_glmm_generated_model_namespace {
...
class logit_glmm_generated_model : public prob_grad {
private:
    int NG;
    int N;
    int K;
    ...
    vector<vector_d> x;
    vector<int> y_group;
    matrix_d beta_prior_info;
    vector_d beta_prior_mean;
    double mu_prior_mean;
    double mu_prior_info;
    double tau_prior_alpha;
    double tau_prior_beta;
public:
    logit_glmm_generated_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "logit_glmm_generated_model_namespace::logit_glmm_generated_model";
        ...
        context__.validate_dims("data initialization", "beta_prior_info", "matrix_d", context__.to_vec(K,K));
        validate_non_negative_index("beta_prior_info", "K", K);
        validate_non_negative_index("beta_prior_info", "K", K);
        beta_prior_info = matrix_d(static_cast<Eigen::VectorXd::Index>(K),static_cast<Eigen::VectorXd::Index>(K));
        vals_r__ = context__.vals_r("beta_prior_info");
        pos__ = 0;
        size_t beta_prior_info_m_mat_lim__ = K;
        size_t beta_prior_info_n_mat_lim__ = K;
        for (size_t n_mat__ = 0; n_mat__ < beta_prior_info_n_mat_lim__; ++n_mat__) {
            for (size_t m_mat__ = 0; m_mat__ < beta_prior_info_m_mat_lim__; ++m_mat__) {
                beta_prior_info(m_mat__,n_mat__) = vals_r__[pos__++];
            }
        }
        ...
        context__.validate_dims("data initialization", "mu_prior_info", "double", context__.to_vec());
        mu_prior_info = double(0);
        vals_r__ = context__.vals_r("mu_prior_info");
        pos__ = 0;
        mu_prior_info = vals_r__[pos__++];
    ...
    T__ log_prob(vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(multi_normal_prec_log<propto__>(beta, beta_prior_mean, beta_prior_info));
            current_statement_begin__ = 28;
            lp_accum__.add(normal_log<propto__>(mu, mu_prior_mean, (1.0 / sqrt(mu_prior_info))));
    ...
    void write_array(RNG& base_rng__,
        ...
        static const char* function__ = "logit_glmm_generated_model_namespace::write_array";
        (void) function__; // dummy call to supress warning
    ...
    static std::string model_name() {
        return "logit_glmm_generated_model";
    }
...
typedef logit_glmm_generated_model_namespace::logit_glmm_generated_model stan_model;
